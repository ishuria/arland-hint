...
def call_with_prompt(request, access_token):
    url = "https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/llama_3_70b?access_token=" + access_token
...
if __name__ == '__main__':
    ...
    for i in range(len(it_item_index_id_mapping)):
        ...
        original_answer = get_llm_answer('llama_3_70b', item_id)
